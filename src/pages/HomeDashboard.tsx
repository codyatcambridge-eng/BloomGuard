    ...
    <div className="min-h-screen pb-24 warroom-bg relative overflow-hidden flex items-center justify-center">
      <main className="relative z-10 w-full max-w-md px-5">
        <header className="text-center mb-8">
          ...
          <p className="mt-1 text-aqua font-display tracking-wide">Tomorrow</p>
          <p className="mt-1 text-aqua font-display tracking-wide">Plants</p>
          <p className="mt-1 text-aqua font-display tracking-wide">deadplants</p>
          <p className="mt-1 text-aqua font-display tracking-wide">Jesus</p>
          <p className="mt-1 text-aqua font-display tracking-wide">toggle</p>
          <p className="mt-1 text-aqua font-display tracking-wide">add</p>
          <p className="mt-1 text-aqua font-display tracking-wide">tellem</p>
          {isActive && (
