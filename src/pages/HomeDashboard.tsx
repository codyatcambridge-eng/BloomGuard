    ...
    <div className="min-h-screen pb-24 warroom-bg relative overflow-hidden flex items-center justify-center">
      <main className="relative z-10 w-full max-w-md px-5">
        <header className="text-center mb-8">
          ...
          <p className="mt-1 text-aqua font-display tracking-wide">nosoft</p>
          <p className="mt-1 text-aqua font-display tracking-wide">p0off</p>
          <p className="mt-1 text-aqua font-display tracking-wide">exitwhite1</p>
          <p className="mt-1 text-aqua font-display tracking-wide">exitwhite2</p>
          {isActive && (
