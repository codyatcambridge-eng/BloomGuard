...
public class InAppBrowserPlugin: CAPPlugin, CAPBridgedPlugin {
    ...
    private func attachWebViewToController(_ webViewController: WKWebViewController, webView: WKWebView) {
        ...
        let topConstraint = webView.topAnchor.constraint(equalTo: webViewController.view.safeAreaLayoutGuide.topAnchor)
        let leadingConstraint = webView.leadingAnchor.constraint(equalTo: webViewController.view.leadingAnchor)
        let trailingConstraint = webView.trailingAnchor.constraint(equalTo: webViewController.view.trailingAnchor)
    ...
    @objc func postMessage(_ call: CAPPluginCall) {
        ...
        let eventType = (eventData["type"] as? String) ?? "unknown"
        print("[InAppBrowser] postMessage detail summary type=\(eventType) keys=\(eventData.keys.count)")
