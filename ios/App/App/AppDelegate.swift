...
#if DEBUG
        print("[ContentFilterBridge] posting MWInAppBrowserDidAttachWebView")
#endif
...
#if DEBUG
        print("[ContentFilterBridge] posting MWInAppBrowserDidDetachWebView")
#endif
        NotificationCenter.default.post(
...
#if DEBUG
        print("[ContentFilterBridge] swizzled viewDidAppear for \(type(of: self))")
#endif
